...
public class Devices extends Base {
    ...
    @Test
    public void Devices() {
        //Checking for heading Devices
        List<WebElement> heading = driver.findElements(By.xpath("//div[@class='page']//h2[contains(text(),'Devices')]"));
        Assert.assertEquals(1, heading.size());

        /* Clicking New Dynamic Field button */

        driver.findElement(By.xpath("//div[@class='page']//btn[@text='New Device']")).click();

        /*Verifying the page header 'New Dynamic Field' */

        WebElement pageName3 = driver.findElement(By.xpath("//ul[@class='breadcrumb-list']//li[contains(text(),'New Device')]"));
        System.out.println(pageName3.getText());
        Assert.assertEquals("New Device", pageName3.getText());
        System.out.println("Heading New Device is verified");
        ...
        driver.findElement(By.xpath("//div[@class='page-edit']//text-box[1]//input[@type='text']")).sendKeys("TestName_New Device");
        ...
        driver.findElement(By.xpath("//div[@class='page-edit']//text-box[2]//input[@type='text']")).sendKeys("Test Config Name _New Device");
        ...
        driver.findElement(By.xpath("//div[@class='page-edit']//text-box[3]//input[@type='text']")).sendKeys("Test Description _New Device");
